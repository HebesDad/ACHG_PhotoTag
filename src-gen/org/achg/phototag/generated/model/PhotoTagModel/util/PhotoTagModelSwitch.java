 ...
 * @generated
 */
public class PhotoTagModelSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case PhotoTagModelPackage.ROOT:
			{
			...
			case PhotoTagModelPackage.FOLDER:
			{
			...
			case PhotoTagModelPackage.IMAGE:
			{
			...
			case PhotoTagModelPackage.TAG_CATEGORY:
			{
			...
			case PhotoTagModelPackage.TAG_VALUE:
			{
			...
			case PhotoTagModelPackage.TAG_VALUE_COORDINATE:
			{
				TagValueCoordinate tagValueCoordinate = (TagValueCoordinate)theEObject;
				T result = caseTagValueCoordinate(tagValueCoordinate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tag Value Coordinate</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tag Value Coordinate</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTagValueCoordinate(TagValueCoordinate object)
	{
		return null;
	}
